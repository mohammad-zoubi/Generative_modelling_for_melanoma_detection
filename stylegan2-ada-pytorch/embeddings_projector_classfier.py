...
def vector_to_mat(file_path, save):
...
def npy_to_tsv(w_matrix):
    np.savetxt("latent_vectors.tsv", w_matrix, delimiter="\t")

def sprite(image_folder_path):
    ...
    spriteimage.convert("RGB").save('/data/GITHUB_REPO/Generative_modelling/stylegan2-ada-pytorch/ISIC_POOL.jpg', transparency=0)
